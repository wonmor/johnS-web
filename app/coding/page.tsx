...
export default function Coding() {
    return (
        <div className="m-auto mb-5 justify-center items-center flex flex-col gap-4 relative md:w-1/2 p-5 md:p-0">
              <a
            href="https://apps.apple.com/us/app/uc-irvine-classfinder/id6460809805"
            target="_blank"
            ...
            <div className="md:w-1/2">
              <p className="text-2xl mb-10">
                ...
                <span className="text-lg font-light">
                  A simple and easy way to find classes at UC Irvine. Also offers social features to connect with other students.
                </span>
              </p>
          ...
          <a
            href="https://play.google.com/store/apps/details?id=com.johnseong.aspiehelper"
            target="_blank"
            rel="noopener noreferrer"
            className="border-gray-600 border-2 rounded-xl p-5 hover:bg-gray-600 relative z-10 flex md:flex-row flex-col items-center"
          >
            <div className="md:w-1/2">
              <p className="text-2xl mb-10">
                Aspie Guide,<br />A Travel Companion.
                <br />
                <br />
                <span className="font-thin py-2">TAP TO NAVIGATE</span>
                <br />
                <br />
                <span className="text-lg font-light">
                  Designed to help those with Asperger's Syndrome or ADHD navigate the world.
                </span>
              </p>
          ...
          >
            <div className="md:w-1/2">
              <p className="text-2xl mb-10">
                ElectronVisualized,<br />The Ultimatum.
                <br />
                <br />
                <span className="font-thin py-2">TAP TO NAVIGATE</span>
                <br />
...
/>
          ...
          >
            <div className="md:w-1/2">
              <p className="text-2xl mb-10">
                Meet Atomizer AR,<br />The Mixed Reality Experience.
                <br />
                <br />
                <span className="font-thin py-2">TAP TO NAVIGATE</span>
                <br />
          ...
          >
            <div className="md:w-1/2">
              <p className="text-2xl mb-10">
                Meet Electronify,<br />New Way to Learn Chemistry.
                <br />
                <br />
                <span className="font-thin py-2">TAP TO NAVIGATE</span>
                <br />
                <br />
                <span className="text-lg font-light">
                  An intuitive way to understand quantum mechanics.
                </span>
              </p>
